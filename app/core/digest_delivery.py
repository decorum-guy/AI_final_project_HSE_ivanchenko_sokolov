...
LONG_DIGEST_TEXT = (
    "К сожалению, сгенерированный дайджест не помещается в одно сообщение Telegram.\n\n"
    "Предлагаю открыть его в формате страницы сайта или получить несколькими сообщениями прямо здесь."
)
